  ...
  var PORTAL_SERVICES = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Cập nhật US', desc: 'Cập nhật nội dung US đã đăng ký: prompt/luồng AI, demo, kế hoạch tháng, số liệu', view: 'weekly-update', roles: ['user','champion','admin'],
        ...
        { label: 'US H1', desc: 'Tra cứu & xem lại use case kỳ H1 (chỉ đọc)', view: 'us-h1', roles: ['user','champion','admin'],
          icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="24" height="24"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" /></svg>' },
        { label: 'Bài tập AI', desc: 'Chia sẻ & tra cứu các thao tác AI nhỏ (prompt + demo)', view: 'ai-exercise', roles: ['user','champion','admin'],
