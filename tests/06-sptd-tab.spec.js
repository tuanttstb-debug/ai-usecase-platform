...
const SPTD_UC_LIST = [
  {
    ...
    status: 'Approved', submit_date: '2026-05-06',
  ...
  },
  {
    ...
    name: 'UC user01 week3', team: 'Team ABC',
    owner_email: 'user01', owner_name: 'User Test',
    status: 'Approved', submit_date: '2026-05-19',
  ...
  },
  {
    ...
    name: 'UC admin week2', team: 'Team Số',
    owner_email: 'tuantt4', owner_name: 'Tuan TT4',
    status: 'Approved', submit_date: '2026-05-12',
  ...
  // Draft UC — should NOT count in SPTD
  {
    ...
    owner_email: 'user01', owner_name: 'User Test',
    status: 'Draft', submit_date: '2026-05-25',
